...
#include <linux/spinlock_types.h> //according to the tutorial for kernel 3.0 - CsG, 2012.12.07.
...
spinlock_t scull_u_lock = __SPIN_LOCK_UNLOCKED(scull_u_lock);
...
spinlock_t scull_w_lock = __SPIN_LOCK_UNLOCKED(scull_w_lock);
